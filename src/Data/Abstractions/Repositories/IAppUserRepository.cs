...
/// <summary>
/// Persists and retrieves <see cref="AppUser"/> instances, isolating <see cref="Application"/>
/// services from the concrete persistence technology.
/// </summary>
public interface IAppUserRepository
{
    ...
    Task<AppUser?> FindByFirebaseUidAsync(string firebaseUid, CancellationToken cancellationToken = default);
    ...
    /// </returns>
    Task<UserProvisioningResult> AddAsync(AppUser user, CancellationToken cancellationToken = default);
}

/// <summary>
/// The outcome of <see cref="IAppUserRepository.AddAsync"/>.
/// </summary>
